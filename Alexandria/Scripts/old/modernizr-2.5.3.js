...
window.Modernizr = (function( window, document, undefined ) {
    ...
    // This test is only for clip DirectoryPaths in SVG proper, not clip DirectoryPaths on HTML content
    // demo: srufaculty.sru.edu/david.dailey/svg/newstuff/clipPath4.svg

    // However read the comments to dig into applying SVG clipDirectoryPaths to HTML content here:
